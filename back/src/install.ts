...
import { COLLECTION_CUSTOMER, COLLECTION_DEPLOYMENT_OPTION, COLLECTION_FEATURE, COLLECTION_FEATURE_VERSION, COLLECTION_NETWORK_ENTITY, COLLECTION_NETWORK_FUNCTION, COLLECTION_OPERATOR, COLLECTION_PACKAGE_MAIN, COLLECTION_PACKAGE_SUB, COLLECTION_RADIO_ACCESS_TECH, COLLECTION_RAN_SHARING, COLLECTION_USER, EDGE_COLECTION_SUCCEEDS, EDGE_COLLECTION_COMMITS, EDGE_COLLECTION_DERIVED_FROM, EDGE_COLLECTION_FORKED_FROM, EDGE_COLLECTION_IMPLEMENTS, EDGE_COLLECTION_OWNS, EDGE_COLLECTION_REGISTERS, EDGE_COLLECTION_REQUIRES, EDGE_COLLECTION_TARGETS } from './constants';
...
const docCollectionNameList = [
  ...
  COLLECTION_NETWORK_ENTITY,
  COLLECTION_NETWORK_FUNCTION,
  COLLECTION_OPERATOR,
